...
const MovidCardItemCompoment:FC<MovidCardItemProps> = ({image , title , release_date , duration}) => {
    return(
        <div className="flex p-3 bg-gray-700 w-auto rounded-xl me-5">
            <img src={image} alt="" srcSet="" className="object-cover w-24 h-full rounded-2xl" />
